...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/aruco-marker/aruco-marker.js":[function(require,module,exports) {
var define;
...
var markerCont = document.createElement("div");
var startFrom = 0;
var startParam = parseInt(findGetParameter("start"), 10);
if (startParam) startFrom = startParam; // A4: 793 px x 1000 px

var widthPrint = 793;
var maxWidth = 7;
var widthMarker = widthPrint / maxWidth;
var heightPrint = 1000;
var maxHeight = Math.round(heightPrint / widthMarker);
alert("PRINTED: " + maxWidth * maxHeight + " markers - from: " + startFrom + " to " + parseInt(startFrom + maxWidth * maxHeight, 10));

for (var j = 0; j < maxWidth; j++) {
  for (var i = 0; i < maxHeight; i++) {
    var markerId = startFrom + i + j * maxHeight; //console.log(markerId);

    var myMarker = new ArucoMarker(markerId);
    var svgImage = myMarker.toSVG(widthMarker + "px"); // the size is optional

    var markerSvg = document.createElement("span");
    markerSvg.id = "marker1";
    if (j % 2 && (i + 1) % 2 || (j + 1) % 2 && i % 2) markerSvg.style.filter = "invert(1)";
...
},{"./styles.css":"src/styles.css","aruco-marker":"node_modules/aruco-marker/aruco-marker.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
